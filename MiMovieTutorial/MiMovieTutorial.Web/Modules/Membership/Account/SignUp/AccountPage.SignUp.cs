...
using MiMovieTutorial.Administration;
using MiMovieTutorial.Administration.Entities;
using MiMovieTutorial.Administration.Repositories;
using MiMovieTutorial.Common;
using Serenity;
using Serenity.Data;
...
namespace MiMovieTutorial.Membership.Pages
{
