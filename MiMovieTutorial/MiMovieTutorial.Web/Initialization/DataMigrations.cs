...
namespace MiMovieTutorial
{
    ...
    {
        // Aqui debe agregarse un Key por cada kadena de appsetting
        ...
        private void RunMigrations(string databaseKey)
        {
            ...
            // remove these lines if you want MiMovieTutorial migrations to run on your DB.
            ...
            var serviceProvider = new ServiceCollection()
                ...
                {
                    options.Namespace = "MiMovieTutorial.Migrations." + databaseKey + "DB";
                })
