...
declare namespace MultiTenancy.Administration {
    ...
    namespace TenantsRow {
        ...
        const deletePermission = "PermissionKeys:Tenants";
        const insertPermission = "PermissionKeys:Tenants";
        const readPermission = "PermissionKeys:Tenants";
        const updatePermission = "PermissionKeys:Tenants";
        const enum Fields {
            TenantId = "TenantId",
