...
using MultiTenancy.Common.Entities;
using Serenity;
...
using System.Text;
using MyRow = MultiTenancy.Administration.Entities.UserRow;
...
namespace MultiTenancy.Administration.Repositories
{
    public partial class UserRepository : BaseRepository
    {
        ...
        private class MySaveHandler : SaveRequestHandler<MyRow>
        {
            ...
            protected override void ValidateRequest()
            {
                ...
                if (IsUpdate)
                {
                    ...
                    // validamos que recupere de la empresa/sucursal
                    if (Row.TenantId != Old.TenantId) ;
                    //   ValidatePermissions(PermissionKeys.Tenants);
                }
            ...
            protected override void SetInternalFields()
            {
                ...
                if (IsCreate)
                {
                    ...
                    // agregamso esto, para setear la empresa/sucursal activa
                    /*
        ...
        private class MyRetrieveHandler : RetrieveRequestHandler<MyRow>
        {
            ...
            // Agregamso ese metodo para filtrar Empresa/Sucrusal
            /*
